...
const config = {
  databaseURI: 'mongodb://wallboard:wallboard1q2w3e4r@192.168.201.4:27017/wallboarddb',
  ...
  serverURL: 'https://172.26.245.153.:' + apiport + '/api', // Don't forget to change to https if needed
  publicServerURL: 'https:// 172.26.245.153:' + apiport + '/api',
  liveQuery: {
